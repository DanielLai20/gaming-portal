...
const Gta = () => {
    ...
    <div className="flex flex-col min-h-screen">
      <div className="max-w-screen text-white p-6 text-center bg-slate-900">
        <div className="max-w-screen-xl m-auto">
          <Nav></Nav>
          <h1>Welcome to the Gta Page</h1>
          <p>This is the Gta page content.</p>
        </div>
      </div>
  ...
  <div className="flex space-x-4">
    <div className="flex flex-col items-center">
      <h3>Live Streams</h3>
      <Link href="https://www.twitch.tv/directory/category/grand-theft-auto-v" target="_blank" rel="noopener noreferrer">
        <Image
    ...
    <div className="flex flex-col items-center">
      <h3>Reviews</h3>
      <Link href="https://www.ign.com/games/grand-theft-auto-v" target="_blank" rel="noopener noreferrer">
        <Image
          className='rounded-lg'
          src={IGN}
          alt=""
