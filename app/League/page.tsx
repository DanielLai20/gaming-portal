...
const League = () => {
    ...
    <div className="flex flex-col min-h-screen">
      <div className="max-w-screen text-white p-6 text-center bg-slate-900">
        <div className="max-w-screen-xl m-auto">
          ...
          <p>This is the League page content.</p>
        </div>
      </div>
  ...
  <div className="flex space-x-4">
    <div className="flex flex-col items-center">
      <h3>Live Streams</h3>
      <Link href="https://www.twitch.tv/directory/category/league-of-legends" target="_blank" rel="noopener noreferrer">
        <Image
    ...
    <div className="flex flex-col items-center">
      <h3>Reviews</h3>
      <Link href="https://www.ign.com/games/league-of-legends" target="_blank" rel="noopener noreferrer">
        <Image
          className='rounded-lg'
          src={IGN}
          alt=""
