  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pb-16 " >
        <div>
          <h1 style={{color:"black"}}>At Game Portal, our mission is to bring transparency and insight into the world of gaming by curating and showcasing the top 10 popular games alongside an immersive
