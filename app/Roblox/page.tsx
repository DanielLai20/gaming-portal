...
const Roblox = () => {
    ...
    <div className="flex flex-col min-h-screen">
      <div className="max-w-screen text-white p-6 text-center bg-slate-900">
        <div className="max-w-screen-xl m-auto">
          <Nav></Nav>
          <h1>Welcome to the Roblox Page</h1>
          <p>This is the Roblox page content.</p>
        </div>
      </div>
  ...
  <div className="flex space-x-4">
    <div className="flex flex-col items-center">
      <h3>Live Streams</h3>
      <Link href="https://www.youtube.com/channel/UCO_8hF-oulap_6lXy0oXLjg" target="_blank" rel="noopener noreferrer">
        <Image
    ...
    <div className="flex flex-col items-center">
      <h3>Reviews</h3>
      <Link href="https://www.ign.com/games/roblox/user-reviews" target="_blank" rel="noopener noreferrer">
        <Image
          className='rounded-lg'
          src={IGN}
          alt=""
